...
class DomainRepositoryMetaGenerator extends GeneratorBase implements Generator {
	...
	private MethodMeta makeMethod(String modelName, String poName, String prefix, String daoPropLow, int type, 
		...
		// ClazzConverter
		String convertName = "com.github.biticcf.mountain.core.common.util.ClazzConverter";
		...
		if (type == 1) {
			...
			String paginationType = getJavaNameAndImport("com.github.biticcf.mountain.core.common.util.PaginationSupport", javaNameMap, importList);
